...
import com.anandpharmacy.order.service.OrderService;
...
public class OrderController {
    ...
    public ApiResponse<?> updateStatus(@PathVariable String orderId, @RequestParam String status) {
        OrderEntity order = orderService.updateStatus(orderId, com.anandpharmacy.common.OrderStatus.valueOf(status));
